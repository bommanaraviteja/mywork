System.register(['angular2/core', './courses.service', './auto-grow.directive'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CouresComponent = (function () {
                function CouresComponent(courseService) {
                    this.title = "Computer Science of Engineering";
                    this.courses = courseService.getCourses();
                }
                CouresComponent = __decorate([
                    core_1.Component({
                        selector: 'courses',
                ...
                return CouresComponent;
            }());
            exports_1("CouresComponent", CouresComponent);
        }
    }
});
